  ...
  return (
    <section id="impact">
      <div className="container">
        <div className="sec-label" data-reveal><span>04 · rules at work</span></div>
        <h2 data-reveal>Not just docs.<br/><span className="accent">Alive.</span></h2>
        <p className="sub" style={{marginBottom: 48}} data-reveal>
          Rules don't sit in a markdown file. They observe, intercept, recalibrate, and archive — continuously.
          Below: 24 hours of real events this mechanism produced.
        </p>
        ...
        <div data-reveal data-reveal-stagger style={{
          ...
          <CounterCard target={147} label="rules total" sub="global + project" />
          <CounterCard target={89} label="fires in 24h" sub="deny + warn + observe" accent="var(--red)" />
          <CounterCard target={42} label="mistakes blocked" sub="avg 12min triage each if they hit" />
          <CounterCard target={8.5} decimals={1} suffix="h" label="time saved" sub="estimated debug-hour equivalent" accent="var(--blue)" />
        </div>
    ...
    <div data-reveal style={{
      ...
      <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'baseline'}}>
        <div>
          ...
          <h3 style={{fontSize: 16, marginTop: 8}}>rule fire heatmap</h3>
        </div>
