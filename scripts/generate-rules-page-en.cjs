// Generate docs/viki-rules.html — English-introduction rule-ledger page
...
<title>Viki — Real Rule Ledger</title>
<style>
...
<div class="page">
  ...
  <div class="hero">
    <div class="hero-grid">
      <div>
        ...
        <h1 class="hero-title">Viki<br>Real Rule Ledger</h1>
    ...
    <div class="hero-intro">
      ...
      (<code>.viki/knowledge.db</code>, <code>~/.viki/global.db</code>) and the hook event log
      (<code>~/.viki/events.db</code>). Rule text is preserved <b>verbatim</b> in its original language — what you see is
  ...
  <div class="footer">
    ...
    <code>.viki/knowledge.db</code>, <code>~/.viki/global.db</code> and
    <code>~/.viki/events.db</code>.<br>
...
const outPath = path.join(cwd, 'docs', 'viki-rules.html');
